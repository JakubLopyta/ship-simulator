...
public class Nomoto2ndOrderModel: MonoBehaviour, IModel
{
	...
	[SerializeField] private double YawRate = 0f;		// r
	[Tooltip("Expressed in rad/s^2")]
	[SerializeField] private double YawAccel = 0f;		// r_dot
	[SerializeField] private double HeadingRad = 0f;	// psi

	[SerializeField] private double currentRudderDeg;
	[SerializeField] private double currentRudderRad;
	private double previousRudderAngle = 0f; // Memory of previous rudder to calculate derivative
